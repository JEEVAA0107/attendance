...
import { Download, TrendingUp, Users, CheckCircle, AlertCircle, XCircle } from 'lucide-react';
                      ...
                      <TableRow key={record.student_id}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            {record.total_hours}/7
                            <div className="w-16 bg-gray-200 rounded-full h-2">
                              <div 
                                className="bg-blue-600 h-2 rounded-full"
                                style={{ width: `${(record.total_hours / 7) * 100}%` }}
                              />
                            </div>
                          </div>
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex flex-wrap gap-1">
                            {record.subjects.map((subject: any, idx: number) => (
                              <Badge 
                                key={idx}
                                variant={subject.is_present ? 'default' : 'secondary'}
                                className="text-xs"
                              >
                                {subject.subject_name.substring(0, 3)}
                              </Badge>
                            ))}
                          </div>
                        </TableCell>
